    ...
    <div class="index" :style ="note">
        <el-row>
            <el-col :xs="{span:12,offset:6}" :sm="{span:12,offset:6}" :md="{span:12,offset:6}" :lg="{span:16,offset:4}" :xl="{span:16,offset:4}">
                <div class="visualization">中国历年GDP和人口数据可视化</div>
            </el-col>
        ...
        <el-row>
            <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
                <Map @showCityName="updateCity" style="margin: 0.125rem;"></Map>
            </el-col>
            <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
                <el-rol>
                <div class="top10">
                    <div class="title2"><i class="el-icon-s-marketing"></i> 2000-2020{{type}}GDP总量、增速与人口变化</div>
                    <top10 v-bind:country="type"></top10>
                </div>                    
                </el-rol>
                <el-rol>
                    <div class="chart">
                    <div class="title2"><i class="el-icon-s-marketing"></i> 2000-2020所有省份GDP总量、增速与人口变化</div>
                    <div class="title3">*图中 O 圆圈大小代表人口数大小</div>
                    <chart></chart>
                </div>               
                </el-rol>                
            </el-col>
...
<script>
    ...
    import in20 from '@/components/in20/index'
